---
name: browser-use
description: Imitate browser activities and list the components on page. Use this skill when user wants to interact with browser, such as looking up something, or filling forms or even scraping, etc.
---

# Browser Use

Use this skill when user wants to interact with browser, such as looking up something, or filling forms or even scraping, etc.

Follow the tool instructions below.
